...
methodology](https://2degrees-investing.org/resource/pacta/) in a reproducible
way and with a single command.
...
* `pacta_core()` takes paths to output/, input/ and pacta-data/ directories
...
* `pacta_core_with_env()` takes a paths to an environment file defining the
