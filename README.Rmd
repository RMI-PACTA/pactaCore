...
* `pacta_core_with_env()` takes paths to output/, input/ and pacta-data/ directories
...
* `pacta_core_with_env_with_env()` takes a paths to an environment file defining the
