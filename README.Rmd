...
[TestPortfolio_Input.csv](https://github.com/jdhoffa/pactaCore/blob/add_basic_dockerfile/working_dir/20_Raw_Inputs/TestPortfolio_Input.csv),
and a parameters file like
[TestPortfolio_Input_PortfolioParameters.yml](https://github.com/jdhoffa/pactaCore/blob/add_basic_dockerfile/working_dir/20_Raw_Inputs/TestPortfolio_Input.csv)
