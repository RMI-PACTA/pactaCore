...
It defaults to using a file under
your working directory called ".env". Here's mine:
...
You can then setup persistent IO directories for tests with `create_pacta()`.
For example:
...
For tests you may instead create ephemeral IO directories with `local_pacta()`.
