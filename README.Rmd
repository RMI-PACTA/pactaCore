...
methodology](https://2degrees-investing.org/resource/pacta/) reproducibly and
...
* `run_pacta_core()` takes paths to output/, input/ and pacta-data/ directories
(see Setup below). It defaults paths under your working directory:
...
* `run_pacta_core_with_env()` takes a paths to an environment file defining the
paths to the output/, input/ and pacta-data/ directories. It defaults a file
called ".env" under your working directory:
